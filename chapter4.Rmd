...
```
### Commentary
We made a categorical variable of crime rate with the division into quantiles indicated above. We also made datasets ("training" and "test") for testing and implementing the LDA (linear discriminant model).
