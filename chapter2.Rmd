...
### Commentary
The data is a subset from the main data, which includes different questions to students and also some demographical variables. This subdata consists 166 rows as observations and 8 columns as variables: gender, Age, Attitude, deep (deep questions to students), stra (strategic questions to students), surf (surface questions to students).
